...
describe('DwarfUI module registry', function()
    it('loads registered contracts in dependency order', function()
        ...
        assert.equals('dwarfui/tooltip_target_detector', calls[9])
        assert.equals('dwarfui/tooltip_map_target', calls[10])
        assert.equals('dwarfui/tooltip_service', calls[11])
        assert.equals('dwarfui/tooltip_render_hook', calls[12])
    ...
    it('clears consumers before their dependencies', function()
        ...
        assert.equals('dwarfui/tooltip_render_hook', names[#names - 11])
        assert.equals('dwarfui/tooltip_service', names[#names - 10])
        assert.equals('dwarfui/tooltip_map_target', names[#names - 9])
        assert.equals('dwarfui/tooltip_target_detector', names[#names - 8])
