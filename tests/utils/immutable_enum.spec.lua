...
describe('immutable enum utilities', function()
    ...
    it('rejects invalid names, values, and duplicates', function()
        ...
        for _, values in ipairs{
            ...
            end, 'DwarfUI enum names must be strings and values must be numbers.')
        end
    end)
end)
