...
---@return table
local function api()
    return reqscript('dwarfui/context_menu/api')
end

---Returns the current-generation service.
---@return dwarfui.ContextMenuService
local function service()
    return reqscript('dwarfui/context_menu/service').service
end
...
local function registrations()
    return reqscript('dwarfui/context_menu/registration').manager
end
