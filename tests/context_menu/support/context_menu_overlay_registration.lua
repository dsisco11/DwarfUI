...
ContextMenuRegistrationOverlay.ATTRS{
    ...
    default_pos={x=1, y=6},
    desc='DwarfUI context-menu registration probe',
    frame={w=24, h=6},
...
local function process_state()
    dfhack.dwarfui[PROCESS_STATE_SLOT] =
        dfhack.dwarfui[PROCESS_STATE_SLOT] or {
            inputs={},
            selection_count=0,
            selection_context=nil,
        }
    return dfhack.dwarfui[PROCESS_STATE_SLOT]
end
