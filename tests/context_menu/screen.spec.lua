...
local SCREEN_PATH =
    'src/scripts_modinstalled/dwarfui/context_menu/screen.lua'
...
local function screen_fixture()
    ...
    local _, renderer = module_loader.load(repo_root,
        'src/scripts_modinstalled/dwarfui/context_menu/renderer.lua', {
            globals={
...
describe('DwarfUI context-menu screen', function()
